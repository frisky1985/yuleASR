...
*                                       窗口看门狗配置
==================================================================================================*/
#if defined(WDGM_CFG_WWD_ENABLE) && (WDGM_CFG_WWD_ENABLE == STD_ON)
/**
 * @brief WWD触发周期 (ms)
 */
...
*                                       独立看门狗配置
==================================================================================================*/
#if defined(WDGM_CFG_IWD_ENABLE) && (WDGM_CFG_IWD_ENABLE == STD_ON)
/**
 * @brief IWD触发周期 (ms)
 */
...
*                                       Dem事件ID (用于Dem集成)
==================================================================================================*/
#if defined(WDGM_CFG_DEM_INTEGRATION) && (WDGM_CFG_DEM_INTEGRATION == STD_ON)
/**
 * @brief 监督超时事件ID
 */
