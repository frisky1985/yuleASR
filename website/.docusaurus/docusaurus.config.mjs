...
export default {
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "/home/admin/yuleASR/website/sidebars.js",
        ...
        "theme": {
          "customCss": "/home/admin/yuleASR/website/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2026 上海予乐电子科技有限公司 (YuleTech). Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
