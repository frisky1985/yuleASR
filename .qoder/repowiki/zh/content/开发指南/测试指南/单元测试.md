...
## 项目结构
单元测试位于 tests/unit 目录，采用“一个模块一个测试文件”的组织方式；服务层与集成测试分别位于 src/bsw/services/*/src 与 tests/integration/bsw 中。
...
DET["src/bsw/services/det/include/Det.h"]
end
subgraph "服务层测试"
...
subgraph "集成测试"
RUN["tests/integration/bsw/test_runner.c"]
end
subgraph "CI"
CI["ci.yml"]
end
...
- [test_runner.c:15-40](file://tests/integration/bsw/test_runner.c#L15-L40)
- [ci.yml:77-85](file://.github/workflows/ci.yml#L77-L85)
...
- [Det.h](file://src/bsw/services/det/include/Det.h#L17)
- [test_runner.c:12-13](file://tests/integration/bsw/test_runner.c#L12-L13)
