...
A --> F["src/bsw/common/Std_Types.h"]
...
## 附录
- API 参考与数据类型
  - 标准类型与返回值：[docs/api-reference.md:17-56](file://docs/api-reference.md#L17-L56)，[src/bsw/common/Std_Types.h:23-80](file://src/bsw/common/Std_Types.h#L23-L80)
