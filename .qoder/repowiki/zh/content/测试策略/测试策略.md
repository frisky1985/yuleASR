...
- [tests/integration/bsw/integration_test.c](file://tests/integration/bsw/integration_test.c)
- [tests/integration/bsw/test_runner.c](file://tests/integration/bsw/test_runner.c)
...
- 集成测试：位于tests/integration/bsw，包含跨层交互的端到端测试与测试运行器。
...
IT["集成测试<br/>tests/integration/bsw"]
EX["示例工程<br/>examples"]
end
subgraph "验证与报告"
...
- [tests/integration/bsw/integration_test.c:1-200](file://tests/integration/bsw/integration_test.c#L1-L200)
...
- [tests/integration/bsw/integration_test.c:174-514](file://tests/integration/bsw/integration_test.c#L174-L514)
- [tests/integration/bsw/test_runner.c:27-40](file://tests/integration/bsw/test_runner.c#L27-L40)
- [tests/run_tests.sh:1-105](file://tests/run_tests.sh#L1-L105)
- [tests/run_tests.ps1:1-107](file://tests/run_tests.ps1#L1-L107)
...
**图表来源**
- [tests/integration/bsw/integration_test.c:24-66](file://tests/integration/bsw/integration_test.c#L24-L66)
...
**图表来源**
- [tests/integration/bsw/integration_test.c:493-514](file://tests/integration/bsw/integration_test.c#L493-L514)

**章节来源**
- [tests/integration/bsw/integration_test.c:83-160](file://tests/integration/bsw/integration_test.c#L83-L160)
- [tests/integration/bsw/integration_test.c:456-514](file://tests/integration/bsw/integration_test.c#L456-L514)
...
**章节来源**
- [tests/integration/bsw/test_runner.c:18-39](file://tests/integration/bsw/test_runner.c#L18-L39)
...
- [tests/integration/bsw/integration_test.c:20-66](file://tests/integration/bsw/integration_test.c#L20-L66)
- [.github/workflows/ci.yml:61-89](file://.github/workflows/ci.yml#L61-L89)
...
- [tests/integration/bsw/integration_test.c:164-172](file://tests/integration/bsw/integration_test.c#L164-L172)
