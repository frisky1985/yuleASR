...
- 集成测试：位于src/bsw/integration/tests，采用mock与配置覆盖跨层交互。
...
IT["集成测试样例<br/>src/bsw/integration/tests/integration_test.c"]
CFG["集成测试配置<br/>src/bsw/integration/tests/integration_test_cfg.h"]
TR["集成测试运行器<br/>src/bsw/integration/tests/test_runner.c"]
end
subgraph "质量与CI"
...
- [integration_test.c: 跨层mock与配置:164-514](file://src/bsw/integration/tests/integration_test.c#L164-L514)
- [integration_test_cfg.h: 测试配置常量:24-100](file://src/bsw/integration/tests/integration_test_cfg.h#L24-L100)
- [test_runner.c: 集成测试入口:27-39](file://src/bsw/integration/tests/test_runner.c#L27-L39)
- [quality-gates.yml: 覆盖率与质量门禁:123-145](file://.harness/quality-gates.yml#L123-L145)
...
**图表来源**
- [integration_test.c: OS报警与子系统回调:493-514](file://src/bsw/integration/tests/integration_test.c#L493-L514)
- [integration_test_cfg.h: 测试配置常量:77-87](file://src/bsw/integration/tests/integration_test_cfg.h#L77-L87)
...
**章节来源**
- [integration_test_cfg.h: 测试配置常量:24-100](file://src/bsw/integration/tests/integration_test_cfg.h#L24-L100)
- [integration_test.c: mock变量与配置:85-160](file://src/bsw/integration/tests/integration_test.c#L85-L160)
...
- [integration_test.c: 头文件包含:12-71](file://src/bsw/integration/tests/integration_test.c#L12-L71)
...
- [integration_test_cfg.h: 测试规模裁剪:24-41](file://src/bsw/integration/tests/integration_test_cfg.h#L24-L41)
