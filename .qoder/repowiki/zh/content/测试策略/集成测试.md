...
- 测试用例设计：结合 integration_test.c 的五个测试用例，解释测试场景、数据准备与预期验证。
...
图表来源
- [integration_test.c:1-1229](file://src/bsw/integration/tests/integration_test.c#L1-L1229)
- [test_runner.c:1-40](file://src/bsw/integration/tests/test_runner.c#L1-L40)
- [test_framework.h:1-141](file://tests/unit/test_framework.h#L1-L141)
- [integration_test_cfg.h:1-101](file://src/bsw/integration/tests/integration_test_cfg.h#L1-L101)
...
## 核心组件
- 测试用例集合：包含 CAN 信号端到端、NvM 启动恢复、诊断请求端到端、模式切换（BswM→EcuM）、OS 报警周期调度五类场景。
...
章节来源
- [integration_test.c:1001-1224](file://src/bsw/integration/tests/integration_test.c#L1001-L1224)
...
- [integration_test_cfg.h:24-100](file://src/bsw/integration/tests/integration_test_cfg.h#L24-L100)
...
图表来源
- [integration_test.c:24-66](file://src/bsw/integration/tests/integration_test.c#L24-L66)
- [integration_test.c:519-825](file://src/bsw/integration/tests/integration_test.c#L519-L825)
...
- [integration_test.c:910-961](file://src/bsw/integration/tests/integration_test.c#L910-L961)
...
图表来源
- [integration_test.c:1001-1036](file://src/bsw/integration/tests/integration_test.c#L1001-L1036)
...
图表来源
- [integration_test.c:1038-1095](file://src/bsw/integration/tests/integration_test.c#L1038-L1095)
...
图表来源
- [integration_test.c:1097-1153](file://src/bsw/integration/tests/integration_test.c#L1097-L1153)
...
图表来源
- [integration_test.c:1155-1188](file://src/bsw/integration/tests/integration_test.c#L1155-L1188)
...
图表来源
- [integration_test.c:1190-1224](file://src/bsw/integration/tests/integration_test.c#L1190-L1224)
...
章节来源
- [integration_test.c:85-961](file://src/bsw/integration/tests/integration_test.c#L85-L961)
...
- [integration_test_cfg.h:18-100](file://src/bsw/integration/tests/integration_test_cfg.h#L18-L100)
...
章节来源
- [integration_test.c:910-961](file://src/bsw/integration/tests/integration_test.c#L910-L961)
- [integration_test.c:164-172](file://src/bsw/integration/tests/integration_test.c#L164-L172)

## 结论
本集成测试体系通过清晰的测试用例设计、完善的执行框架与配置管理，实现了对 BSW 跨层协作与系统级功能的全面验证。借助 Mock/Stub 与最小化配置，测试具备高可维护性与可扩展性，能够持续保障模块间正确交互与系统整体稳定性。
...
章节来源
- [integration_test.c:981-995](file://src/bsw/integration/tests/integration_test.c#L981-L995)
- [integration_test.c:133-160](file://src/bsw/integration/tests/integration_test.c#L133-L160)
