...
- 模板与类型支撑
  ...
  - src/bsw/os/include/Std_Types.h、src/bsw/services/det/include/Det.h：类型与错误检测支撑
- 运行时环境配置生成
...
plat --> out_can
std["src/bsw/os/include/Std_Types.h<br/>类型定义"] --> out_mcu
std --> out_can
det["src/bsw/services/det/include/Det.h<br/>错误检测接口"] --> out_mcu
det --> out_can
```
