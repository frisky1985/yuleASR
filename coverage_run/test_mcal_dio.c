...
void test_Dio_ReadChannel_ValidHigh(void) {
    ...
    MockRegisters_Write32(DIO_GPIO1_BASE + DIO_GPIO_PSR_OFF, 0x01);
...
void test_Dio_ReadChannel_ValidLow(void) {
    Dio_ConfigType cfg; memset(&cfg, 0, sizeof(cfg));
    Dio_Init(&cfg);
    MockRegisters_Write32(DIO_GPIO1_BASE + DIO_GPIO_PSR_OFF, 0x00);
...
void test_Dio_WriteChannel_ValidHigh(void) {
    ...
    uint32 v = MockRegisters_Read32(DIO_GPIO1_BASE + DIO_GPIO_DR_OFF);
...
void test_Dio_WriteChannel_ValidLow(void) {
    Dio_ConfigType cfg; memset(&cfg, 0, sizeof(cfg));
    Dio_Init(&cfg);
    MockRegisters_Write32(DIO_GPIO1_BASE + DIO_GPIO_DR_OFF, 0x01); /* Start high */
...
void test_Dio_ReadPort_Valid(void) {
    Dio_ConfigType cfg; memset(&cfg, 0, sizeof(cfg));
    Dio_Init(&cfg);
    MockRegisters_Write32(DIO_GPIO1_BASE + DIO_GPIO_PSR_OFF, 0xDEAD);
...
void test_Dio_WritePort_Valid(void) {
    ...
    TEST_ASSERT_EQUAL(0x1234, MockRegisters_Read32(DIO_GPIO1_BASE + DIO_GPIO_DR_OFF));
}
...
void test_Dio_ReadChannelGroup_Valid(void) {
    ...
    MockRegisters_Write32(DIO_GPIO1_BASE + DIO_GPIO_PSR_OFF, 0xAB);
...
void test_Dio_WriteChannelGroup_Valid(void) {
    ...
    Dio_Init(&cfg);
    Dio_ChannelGroupType g = {0, 0, 0x0F};
    MockRegisters_Write32(DIO_GPIO1_BASE + DIO_GPIO_DR_OFF, 0xF0);
    Dio_WriteChannelGroup(&g, 0x05);
    TEST_ASSERT_EQUAL(0xF5, MockRegisters_Read32(DIO_GPIO1_BASE + DIO_GPIO_DR_OFF));
}
...
void test_Dio_FlipChannel_Valid_HighToLow(void) {
    Dio_ConfigType cfg; memset(&cfg, 0, sizeof(cfg));
    Dio_Init(&cfg);
    MockRegisters_Write32(DIO_GPIO1_BASE + DIO_GPIO_DR_OFF, 0x01);
...
void test_Dio_FlipChannel_Valid_LowToHigh(void) {
    Dio_ConfigType cfg; memset(&cfg, 0, sizeof(cfg));
    Dio_Init(&cfg);
    MockRegisters_Write32(DIO_GPIO1_BASE + DIO_GPIO_DR_OFF, 0x00);
...
void test_Dio_MaskedWritePort_Valid(void) {
    Dio_ConfigType cfg; memset(&cfg, 0, sizeof(cfg));
    Dio_Init(&cfg);
    MockRegisters_Write32(DIO_GPIO1_BASE + DIO_GPIO_DR_OFF, 0x00FF);
