#!/bin/bash
# DOCAN Configurator Tool Launcher
...
class SimpleConfigurator:
    def __init__(self, root):
        self.root = root
        self.root.title('DOCAN Configurator')
        ...
        ttk.Label(frame, text='DOCAN Configuration', font=('Arial', 16, 'bold')).pack(pady=10)
    ...
    def load_csv(self):
        ...
        if filepath:
            try:
                ...
                parser = AutosarConfigParser('DOCAN')
