#!/bin/bash
# UDS Configurator Tool Launcher
...
class SimpleConfigurator:
    def __init__(self, root):
        self.root = root
        self.root.title('UDS Configurator')
        ...
        ttk.Label(frame, text='UDS Configuration', font=('Arial', 16, 'bold')).pack(pady=10)
    ...
    def load_csv(self):
        ...
        if filepath:
            try:
                ...
                parser = AutosarConfigParser('UDS')
