#!/bin/bash
# CANTP Configurator Tool Launcher
...
class SimpleConfigurator:
    def __init__(self, root):
        self.root = root
        self.root.title('CANTP Configurator')
        ...
        ttk.Label(frame, text='CANTP Configuration', font=('Arial', 16, 'bold')).pack(pady=10)
    ...
    def load_csv(self):
        ...
        if filepath:
            try:
                ...
                parser = AutosarConfigParser('CANTP')
