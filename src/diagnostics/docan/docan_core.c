...
static DoCan_ConnectionStateType g_DoCan_Connections[DOCAN_MAX_CONNECTIONS];
...
{
    uint8_t connIdx;
    DoCan_ConnectionStateType *conn;
...
static void DoCan_HandleTxState(uint8_t ConnIdx)
{
    DoCan_ConnectionStateType *conn = &g_DoCan_Connections[ConnIdx];
