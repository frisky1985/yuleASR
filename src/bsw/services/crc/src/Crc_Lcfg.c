/*==================================================================================================
 * FILE: Crc_Lcfg.c
 * DESCRIPTION: AUTOSAR CRC Services - Lookup Tables (Link-Time Configuration)
 * PROVIDER: 上海予乐电子科技有限公司 (YuleTech)
 * VERSION: 1.0.0
 *
 * GENERATED TABLES:
 * - CRC8 Table: SAE J1850 polynomial 0x1D
 * - CRC16 Table: CCITT-FALSE polynomial 0x1021
 ...
 * CONFIGURATION INSTANCE
 ==================================================================================================*/
const Crc_ConfigType Crc_Config = {
#if (CRC_8_MODE == STD_ON)
    .Crc8_Enabled = TRUE,
    .Crc8_Polynomial = CRC_8_POLYNOMIAL,
    .Crc8_InitValue = CRC_8_INITIAL_VALUE,
#else
    .Crc8_Enabled = FALSE,
    .Crc8_Polynomial = 0U,
    .Crc8_InitValue = 0U,
#endif
#if (CRC_16_MODE == STD_ON)
    .Crc16_Enabled = TRUE,
    .Crc16_Polynomial = CRC_16_POLYNOMIAL,
    .Crc16_InitValue = CRC_16_INITIAL_VALUE,
#else
    .Crc16_Enabled = FALSE,
    .Crc16_Polynomial = 0U,
    .Crc16_InitValue = 0U,
#endif
#if (CRC_32_MODE == STD_ON)
    .Crc32_Enabled = TRUE,
    .Crc32_Polynomial = CRC_32_POLYNOMIAL,
    .Crc32_InitValue = CRC_32_INITIAL_VALUE
#else
    .Crc32_Enabled = FALSE,
    .Crc32_Polynomial = 0U,
    .Crc32_InitValue = 0U
