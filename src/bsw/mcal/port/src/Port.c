...
#define PORT_GPIO1_BASE_ADDR            (S32K312_SIUL2_GPIO_BASE + 0 * 0x1000)
#define PORT_GPIO2_BASE_ADDR            (S32K312_SIUL2_GPIO_BASE + 1 * 0x1000)
#define PORT_GPIO3_BASE_ADDR            (S32K312_SIUL2_GPIO_BASE + 2 * 0x1000)
#define PORT_GPIO4_BASE_ADDR            (S32K312_SIUL2_GPIO_BASE + 3 * 0x1000)
#define PORT_GPIO5_BASE_ADDR            (S32K312_SIUL2_GPIO_BASE + 4 * 0x1000)
#define PORT_IOMUXC_SW_MUX_CTL_PAD_OFFSET   (SIUL2_MSCR0_OFF)
#define PORT_IOMUXC_SW_PAD_CTL_PAD_OFFSET   (SIUL2_MSCR0_OFF + 4)
