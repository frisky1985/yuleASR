...
)
{
    ...
    dmaConfig.DestAddr = UART1_BASE_ADDR + UART_UTXD_OFFSET + (Channel * 0x40000U);
...
)
{
    ...
    dmaConfig.SourceAddr = UART1_BASE_ADDR + UART_URXD_OFFSET + (Channel * 0x40000U);
