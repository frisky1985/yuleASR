/**
 * @file Rte_Cfg.h
 * @brief Rte Configuration configuration header
 * @version 1.0.0
 * @date 2026-08-10
...
#define RTE_PORT_EC_RPM_H    (((RTE_COMPONENT_ASW_ENGINE_CONTROL << 8) | RTE_PORT_EC_RPM))
#define RTE_PORT_EC_SPEED_H    (((RTE_COMPONENT_ASW_ENGINE_CONTROL << 8) | RTE_PORT_EC_SPEED))
#define RTE_PORT_EC_TEMPERATURE_H    (((RTE_COMPONENT_ASW_ENGINE_CONTROL << 8) | RTE_PORT_EC_TEMPERATURE))
#define RTE_PORT_EC_THROTTLE_H    (((RTE_COMPONENT_ASW_ENGINE_CONTROL << 8) | RTE_PORT_EC_THROTTLE))
#define RTE_PORT_EC_FUEL_INJECTION_H    (((RTE_COMPONENT_ASW_ENGINE_CONTROL << 8) | RTE_PORT_EC_FUEL_INJECTION))
#define RTE_PORT_VD_YAW_RATE_H    (((RTE_COMPONENT_ASW_VEHICLE_DYNAMICS << 8) | RTE_PORT_VD_YAW_RATE))
#define RTE_PORT_VD_WHEEL_SPEED_H    (((RTE_COMPONENT_ASW_VEHICLE_DYNAMICS << 8) | RTE_PORT_VD_WHEEL_SPEED))
#define RTE_PORT_VD_STEERING_ANGLE_H    (((RTE_COMPONENT_ASW_VEHICLE_DYNAMICS << 8) | RTE_PORT_VD_STEERING_ANGLE))
#define RTE_PORT_DM_DTC_STATUS_H    (((RTE_COMPONENT_ASW_DIAGNOSTIC_MANAGER << 8) | RTE_PORT_DM_DTC_STATUS))
#define RTE_PORT_DM_CLEAR_DTC_H    (((RTE_COMPONENT_ASW_DIAGNOSTIC_MANAGER << 8) | RTE_PORT_DM_CLEAR_DTC))
#define RTE_PORT_DM_READ_DTC_H    (((RTE_COMPONENT_ASW_DIAGNOSTIC_MANAGER << 8) | RTE_PORT_DM_READ_DTC))
#define RTE_PORT_CM_VEHICLE_SPEED_H    (((RTE_COMPONENT_ASW_COMMUNICATION_MANAGER << 8) | RTE_PORT_CM_VEHICLE_SPEED))
#define RTE_PORT_CM_STATUS_H    (((RTE_COMPONENT_ASW_COMMUNICATION_MANAGER << 8) | RTE_PORT_CM_STATUS))
#define RTE_PORT_SM_DATA_READ_H    (((RTE_COMPONENT_ASW_STORAGE_MANAGER << 8) | RTE_PORT_SM_DATA_READ))
#define RTE_PORT_SM_DATA_WRITE_H    (((RTE_COMPONENT_ASW_STORAGE_MANAGER << 8) | RTE_PORT_SM_DATA_WRITE))
#define RTE_PORT_IO_INPUT_H    (((RTE_COMPONENT_ASW_IO_CONTROL << 8) | RTE_PORT_IO_INPUT))
#define RTE_PORT_IO_OUTPUT_H    (((RTE_COMPONENT_ASW_IO_CONTROL << 8) | RTE_PORT_IO_OUTPUT))
#define RTE_PORT_MM_CURRENT_MODE_H    (((RTE_COMPONENT_ASW_MODE_MANAGER << 8) | RTE_PORT_MM_CURRENT_MODE))
#define RTE_PORT_MM_TARGET_MODE_H    (((RTE_COMPONENT_ASW_MODE_MANAGER << 8) | RTE_PORT_MM_TARGET_MODE))
#define RTE_PORT_WM_STATUS_H    (((RTE_COMPONENT_ASW_WATCHDOG_MANAGER << 8) | RTE_PORT_WM_STATUS))
#define RTE_PORT_WM_RESET_H    (((RTE_COMPONENT_ASW_WATCHDOG_MANAGER << 8) | RTE_PORT_WM_RESET))
#define RTE_PORT_WM_TRIGGER_H    (((RTE_COMPONENT_ASW_WATCHDOG_MANAGER << 8) | RTE_PORT_WM_TRIGGER))
...
#define RTE_NVMBLOCK_ODOMETER    (5U)
#define RTE_NVMBLOCK_VIN    (4U)
#define RTE_NVMBLOCK_ERROR_LOG    (3U)
#define RTE_NVMBLOCK_CALIBRATION_DATA    (2U)
#define RTE_NVMBLOCK_USER_SETTINGS    (6U)
#define RTE_PORT_NVM_READ    (768U)
