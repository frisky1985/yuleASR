...
/* Compatibility: older unity lacks TEST_ASSERT_NOT_EQUAL */
...
void test_double_bit_error_in_data_32bit(void)
{
    ...
    for (uint8_t bit1 = 0; bit1 < 31; bit1++) {
        for (uint8_t bit2 = bit1 + 1; bit2 < 32; bit2++) {
            ...
            (void)EccChecker_Check32(corrupted_data, ecc_code, &result);
...
void test_double_bit_error_in_ecc_code_32bit(void)
{
    ...
    for (uint8_t bit1 = 0; bit1 < 6; bit1++) {
        for (uint8_t bit2 = bit1 + 1; bit2 < 7; bit2++) {
            ...
            (void)EccChecker_Check32(original_data, corrupted_ecc, &result);
...
void test_double_bit_error_data_and_ecc_32bit(void)
{
    ...
    (void)EccChecker_Check32(corrupted_data, corrupted_ecc, &result);
...
void test_double_bit_error_in_data_64bit(void)
{
    ...
    for (size_t i = 0; i < sizeof(test_pairs) / sizeof(test_pairs[0]); i++) {
        ...
        (void)EccChecker_Check64(corrupted_data, ecc_code, &result);
...
void test_double_bit_error_in_ecc_code_64bit(void)
{
    ...
    for (uint8_t bit1 = 0; bit1 < 7; bit1++) {
        for (uint8_t bit2 = bit1 + 1; bit2 < 8; bit2++) {
            ...
            (void)EccChecker_Check64(original_data, corrupted_ecc, &result);
...
void test_double_bit_error_statistics(void)
{
    ...
    uint32_t errors_before = stats_before->double_bit_errors;
    ...
    TEST_ASSERT_GREATER_THAN(errors_before, stats_after->double_bit_errors);
    TEST_ASSERT_EQUAL(5, stats_after->double_bit_errors - errors_before);
}
...
int main(void)
{
    ...
    UnityRunTest(test_double_bit_error_in_data_32bit, "test_double_bit_error_in_data_32bit", __LINE__);
    UnityRunTest(test_double_bit_error_in_ecc_code_32bit, "test_double_bit_error_in_ecc_code_32bit", __LINE__);
    UnityRunTest(test_double_bit_error_data_and_ecc_32bit, "test_double_bit_error_data_and_ecc_32bit", __LINE__);
    
    /* 64-bit double-bit error tests */
    UnityRunTest(test_double_bit_error_in_data_64bit, "test_double_bit_error_in_data_64bit", __LINE__);
    UnityRunTest(test_double_bit_error_in_ecc_code_64bit, "test_double_bit_error_in_ecc_code_64bit", __LINE__);
    
    /* Adjacent bit error tests */
    UnityRunTest(test_adjacent_double_bit_errors_32bit, "test_adjacent_double_bit_errors_32bit", __LINE__);
    UnityRunTest(test_adjacent_double_bit_errors_64bit, "test_adjacent_double_bit_errors_64bit", __LINE__);
    
    /* Statistical tests */
    UnityRunTest(test_double_bit_error_statistics, "test_double_bit_error_statistics", __LINE__);
