...
| **模块 ID** | 0x53 |
| **功能** | 以太网驱动 |
| **描述** | 提供 10/100/1000 Mbps 以太网 MAC 操作 |
| **主要 API** | Eth_Init, Eth_Transmit, Eth_Receive, Eth_SetControllerMode |
| **状态** | ✅ 已完成 (v1.1.0) |

**功能特性：**
- 以太网 MAC 控制器初始化
- 10/100/1000 Mbps 速率支持
- MII/RMII 接口支持
- MAC 地址管理 (设置/获取/过滤)
- 发送/接收中断处理
- PHY MII 接口读写
...
| **模块 ID** | 0x10 |
| **功能** | 输入捕获驱动 |
| **描述** | 提供输入捕获、时间测量和边沿检测功能 |
| **主要 API** | Icu_Init, Icu_StartTimestamp, Icu_GetDutyCycleValues |
| **状态** | ✅ 已完成 (v1.1.0) |
...
| **功能** | 输出比较驱动 |
| **描述** | 提供输出比较功能和引脚动作控制 |
| **主要 API** | Ocu_Init, Ocu_SetAbsoluteThreshold, Ocu_SetPinAction |
| **状态** | ✅ 已完成 (v1.1.0) |
| **ASIL 等级** | D |
...
| **模块 ID** | 0x2D |
| **功能** | FlexRay 传输协议 |
| **描述** | 提供 ISO TP 分段传输协议支持 |
| **主要 API** | FrTp_Init, FrTp_Transmit, FrTp_RxIndication |
| **状态** | ✅ 已完成 (v1.1.0) |
...
| 版本 | 日期 | 变更描述 |
|:-----|:-----|:---------|
| 1.1.0 | 2026-04-29 | 新增 4 个模块 (Eth, Icu, Ocu, FrTp)，完善车载网络支持 |
