...
extern void test_dlt_autosar_compliance_suite(void);
extern void test_dlt_control_messages_suite(void);
...
int main(void) {
    ...
    test_dlt_suite();
    test_adapter_suite();
    test_dlt_autosar_compliance_suite();
    test_dlt_control_messages_suite();
