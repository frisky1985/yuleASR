...
/* Event groups + timers + mutexes required by the yuleASR Os wrapper
 * (Os_Internal_ActivateTask -> xEventGroupCreate, Os_InitAlarms ->
 * xTimerCreate, Os_InitResources -> xSemaphoreCreateMutex). */
