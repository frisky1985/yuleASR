...
#endif
#ifndef REG_WRITE32
#define REG_WRITE32(addr, val)          (*((volatile uint32*)(uintptr)(addr)) = (val))
#endif
#ifndef REG_READ8
#define REG_READ8(addr)                 (*((volatile uint8*)(uintptr)(addr)))
#endif
#ifndef REG_WRITE8
#define REG_WRITE8(addr, val)           (*((volatile uint8*)(uintptr)(addr)) = (val))
#endif
