 ...
 * VERSION: 1.0.0
 *
 * NOTE: 统一头文件（2026-08-14）。此前 include/autosar 下为旧版（无 Crc_Cfg.h include），
 *       CMake include 顺序优先命中旧版导致 CRC_16_MODE 未定义 → Crc_CalculateCRC16 恒返回 0。
 *       现已与 src/bsw/services/crc/include/Crc.h 对齐（含 Crc_Cfg.h），
 *       并保留 Crc_CalculateCRC64 声明（E2E P05/P06 编译依赖）。
 ==================================================================================================*/
...
/**
 * @brief Calculate CRC64 (E2E P05/P06 profile dependency)
 * @param data Pointer to data buffer
 * @param len Length of data in bytes
 * @param crc Initial CRC value
 * @param first TRUE if first call for this data stream
